...
describe('process_sonos_command', () => {
  ...
  const commands = [
    ...
    {
      service: 'BBC Sounds',
      input: `bbcsounds:${identifier}`,
      expected_url: get_sonos_url(`bbcsounds/play/${identifier}`, 'bbcsounds'),
    },
    {
    ...
    {
      service: 'Favorite',
      input: `favorite:${identifier}`,
      expected_url: get_sonos_url(`favorite/${identifier}`, 'favorite'),
    },
    {
